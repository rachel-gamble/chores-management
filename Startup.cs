...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "choresmanagement", Version = "v1" });
        });
        ...
        // NOTE need to add our repo and service so they can be accessed in the appropriate constructors
        // NOTE REPO SHOULD BE SCOPED OR TRANSIENT, only using singleton for FAKEDB
